...
class ArticleListVIewVertical extends StatefulWidget {
  const ArticleListVIewVertical({required this.articles, super.key});

  final List<Article> articles;

  @override
  State<ArticleListVIewVertical> createState() =>
      _ArticleListVIewVerticalState();
}

class _ArticleListVIewVerticalState extends State<ArticleListVIewVertical> {
